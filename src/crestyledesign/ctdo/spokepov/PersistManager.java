...
public class PersistManager {
	...
	public static boolean saveCHeaderFile(String filename, FileDataObject obj) {
		...
		try {
	        ...
	        sbRed.append("\r\nconst uint8_t red[" + obj.getAngularSteps() + "][" + obj.getLedCount() + "] PROGMEM = {\r\n");
	        sbGreen.append("\r\nconst uint8_t green[" + obj.getAngularSteps() + "][" + obj.getLedCount() + "] PROGMEM = {\r\n");
	        sbBlue.append("\r\nconst uint8_t blue[" + obj.getAngularSteps() + "][" + obj.getLedCount() + "] PROGMEM = {\r\n");
